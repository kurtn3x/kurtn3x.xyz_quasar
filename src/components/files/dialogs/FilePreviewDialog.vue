...
const VideoView = defineAsyncComponent(
  () => import('src/components/files/previews/VideoView.vue')
);
...
const PdfView = defineAsyncComponent(
  () => import('src/components/files/previews/PdfView.vue')
);
const ImageView = defineAsyncComponent(
  () => import('src/components/files/previews/ImageView.vue')
);
const CodeView = defineAsyncComponent(
  () => import('src/components/files/previews/CodeView.vue')
);
